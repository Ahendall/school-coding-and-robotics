...
class Customer {
   public:
    ...
    // Function that will add item "order" to user's cart. Only works with new orders
...
bool Customer::checkout() {
    ...
    // Updating DB
    db << "UPDATE customers SET cash = ?, prev_order = ?, prev_price = ? WHERE name = ?" << cash << orderStr << price << name;
    return true;
}
...
void printMenu() {
    stringstream ss1;
    ss1 << "+------------------------------+-------+-----------------------------------------+\n";
    ss1 << "|             Item             | Price | order id (type in this number to order) |\n";
    ss1 << "+------------------------------+-------+-----------------------------------------+\n";
    ss1 << "| 2 piece chicken nugget       | $2    |                                       1 |\n";
    ss1 << "| 5 Piece chicken nugget       | $5    |                                       2 |\n";
    ss1 << "| 10 (+1) Piece chicken nugget | $10   |                                       3 |\n";
    ss1 << "| Small fries                  | $1.25 |                                       4 |\n";
    ss1 << "| Medium fries                 | $2.25 |                                       5 |\n";
    ss1 << "| Large fries                  | $4.20 |                                       6 |\n";
    ss1 << "+------------------------------+-------+-----------------------------------------+\n\n";
